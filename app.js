...
const KO_STATIC = {
  ...
  "story-p3": "그래서 이를 제대로 공부하기 위해 대학원에 진학했습니다. 제 연구는 신체 착용형 햅틱 인터페이스에 관한 것으로, 센서를 설계하고 실제 물리 단위로 보정하며, 신호를 수집하고 분석하고, 실시간으로 분류한 뒤 그 결과를 다시 촉각으로 렌더링하는 과정을 다룹니다. 최근에는 IMU 데이터를 이용해 기기가 신체의 어느 부위에 착용되었는지를 파악해 피드백을 그에 맞게 조정하는 연구와, 질감을 현실로 가져올 수 있는 기술들을 익히는 작업을 진행했습니다.",
